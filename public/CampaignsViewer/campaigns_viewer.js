...
function getColumnDefs() {
    ...
    return [
        ...
        { headerName: " צפיות שנשארו", field: "views_left", cellRenderer: function (params) { return (params.value > 0) ? params.value : 0 } },
        { headerName: " קליקים שנשארו", field: "clicks_left", cellRenderer: function (params) { return (params.value > 0) ? params.value : 0 } },
